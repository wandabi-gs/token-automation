                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="phone_number" name="phone_number"
                            placeholder="Enter phone number : 2547123456" value="<?php echo($_SESSION["user"]["phone_number"]); ?>" required>
                    </div>
                    <div class="form-group">
            ...
            <form class="modal-content" id="addMeterForm" action="/meter/add-meter.php">
                ...
                <div class="modal-body">
                    <div class="mt-3 form-floating">
                        <input class="form-control" type="text" id="meter_number" name="meter_number" placeholder="" required/>
    ...
    <div class="modal fade" id="addMeterPersonModal">
        <div class="modal-dialog modal-dialog-centered">
            <form class="modal-content" action="/meter/add-person.php" id="addMeterPersonForm" method="post">
                ...
                <div class="modal-body">
                    <div class="mt-3 form-floating">
                        <input class="form-control" type="email" id="user_email" name="user_email" placeholder="" required/>
